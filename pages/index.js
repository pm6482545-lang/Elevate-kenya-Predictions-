      ...
      <nav className="bg-[#002D62] text-white sticky top-0 z-50 shadow-md border-b-2 border-[#D4AF37] px-4 py-3">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-5 font-bold text-xs tracking-wide whitespace-nowrap">
            ...
            <button onClick={() => scrollToSection('prediction-exams')} className="hover:text-[#D4AF37] transition uppercase">EXAMS</button>
            ...
            <button className="bg-transparent border-2 border-[#D4AF37] text-white px-3 py-1.5 rounded-md font-black hover:bg-[#D4AF37] hover:text-[#002D62] transition uppercase">Sign Up</button>
          </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-3 pt-3 border-t border-[#D4AF37]/30 space-y-3 pb-3 font-bold text-xs tracking-wider bg-[#002D62] px-2">
            ...
            <button onClick={() => scrollToSection('prediction-exams')} className="block w-full text-left py-1.5 px-2 hover:bg-white/5 hover:text-[#D4AF37] rounded transition">EXAMS</button>
            ...
            <div className="grid grid-cols-2 gap-2 pt-2 border-t border-white/10">
              <button className="w-full text-center py-2 bg-white/10 text-white rounded font-bold uppercase tracking-wider">Sign In</button>
              <button className="w-full text-center py-2 bg-[#D4AF37] text-[#002D62] rounded font-black uppercase tracking-wider">Sign Up</button>
            </div>
          </div>
        )}
      </nav>
      ...
      <section id="services" className="max-w-7xl mx-auto px-4 py-16 scroll-mt-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="group bg-white rounded-xl overflow-hidden border border-gray-200 hover:border-[#002D62] p-5 text-center flex flex-col items-center justify-between min-h-[250px] shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1 w-full">
            ...
            <button className="w-full text-[10px] font-black tracking-wider text-[#002D62] bg-blue-50 py-2 rounded uppercase group-hover:bg-[#002D62] group-hover:text-white transition-colors">
              Access Materials
            </button>
          </div>
